...
import Layout from "./components/ScriptLoader";
    ...
    <>
      <Layout>
        ...
        <Head>
          ...
          <link rel="stylesheet" href="./components/assets/css/lineicons.css" />
          <link rel="stylesheet" href="./components/assets/css/animate.css" />
          <link rel="stylesheet" href="./components/assets/css/tiny-slider.css" />
          <link rel="stylesheet" href="./components/assets/css/glightbox.min.css" />
          <link rel="stylesheet" href="./components/assets/css/space.css" />
          <link rel="stylesheet" href="./components/assets/css/main.css" />
          <link rel="stylesheet" href="./components/assets/css/ud-styles.css" /> */}
        </Head>
